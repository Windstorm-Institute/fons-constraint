...
[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.19274047-blue)](https://doi.org/10.5281/zenodo.19274047)
...
**Zenodo**: [10.5281/zenodo.19274047](https://doi.org/10.5281/zenodo.19274047) · **Current version: v1.0** (March 2026)
...
- **[Zenodo record](https://doi.org/10.5281/zenodo.19274047)** — archived with DOI
...
- **Discuss the paper's ideas** → [Comments on the website article](https://windstorminstitute.org/articles/fons-constraint.html#comments) (powered by GitHub Discussions on the website repo)
- **Typo, citation issue, or paper-content correction?** → [Open an Issue on this repo](../../issues)
- **Bug in the analysis code, or a reproduction question?** → [Issue](https://github.com/Windstorm-Labs/fons-constraint/issues) or [Discussion](https://github.com/Windstorm-Labs/fons-constraint/discussions) on the Labs repo
...
| # | Paper | DOI |
|---|-------|-----|
| 1 | [The Fons Constraint](https://github.com/Windstorm-Institute/fons-constraint) *(this paper)* | [10.5281/zenodo.19274047](https://doi.org/10.5281/zenodo.19274047) |
